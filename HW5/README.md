...
### Теперь уничтожим тестовый стенд командой `vagrant destory -f`, создадим его заново и выполним все пункты из пккта 5 - проверка работоспособности, убедимся, что всё работает как задумывалось и требуется
